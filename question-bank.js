...
//   - Master Quiz (quiz.js) — draws 10 random questions from the WHOLE bank
//   - Pick Your Format (category-quiz-v2.js) — filters by `category` field, draws 10
...
// of its own — these only ever surface in Master Quiz / Speed Round.
//
