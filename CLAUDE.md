...
- Next task: Feature 19 — Stats Dashboard, Step 4: tag all 200+ questions with a cricket era. (Step 5: percentile rank + friends comparison, reusing the existing friends system in leaderboard.html.)
