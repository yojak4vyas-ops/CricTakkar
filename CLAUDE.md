...
- Next task: Feature 19 — Stats Dashboard, Step 5: percentile rank + friends comparison, reusing the existing friends system in leaderboard.html. (A "weakest era" card using the new era tags is also still unbuilt and could be folded into this step or done separately.)
