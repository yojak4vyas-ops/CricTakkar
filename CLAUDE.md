...
- Next task: Feature 19 — Stats Dashboard, Step 3: add the same per-attempt tracking to Speed Round and Ranking Challenge so their stats can be included too. (Step 4: tag all 200+ questions with a cricket era. Step 5: percentile rank + friends comparison, reusing the existing friends system in leaderboard.html.)
