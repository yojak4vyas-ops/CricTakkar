...
- Next task: Feature 20 (Avatar Customisation) — cosmetic unlockables (team jersey, helmet, bat) shown on the profile, using emoji/CSS since there's no art budget. Then Feature 22 (Top 5 section) remains parked for a future session.
