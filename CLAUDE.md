...
- Next task: All parked features remain: Top 5 section (Feature 22), Cricket News Feed (Feature 24), Player Encyclopaedia (Feature 28), Match Day Alert (Feature 26), Push Notifications (Feature 25), Hindi language support (Feature 27), Battle Friends groundwork (Phase 3). If community poems get real usage, revisit moderation — the 3-report auto-hide is a stopgap, not a permanent policy. Should ask the user which of the parked features to pick up next.
