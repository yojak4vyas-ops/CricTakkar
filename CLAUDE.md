...
- Next task: Continue the Four-Source Verification re-check, next up **On This Day** (18 events) and **Ranking Challenge** (5 challenges), which haven't been touched yet under the new rule. After that, still-parked features remain: Top 5 section (Feature 22), Cricket News Feed (Feature 24), Player Encyclopaedia (Feature 28), Match Day Alert (Feature 26), Push Notifications (Feature 25), Hindi language support (Feature 27), Battle Friends groundwork (Phase 3).
